...
const ja = {
  ...
  'drill.cloze.desc': '添削から作った穴埋めカードに挑戦します。難しければヒントで4択に切り替えられます。',
  'drill.cloze.empty': '「復習カードの自動生成」を有効にして添削すると出題されます。',
  'drill.levelup.name': 'レベルアップ・タイピング',
  'drill.levelup.desc':
    '日付を選んで、その日のCEFR一段階上の表現に挑戦します。正解するたびに単語が少しずつ隠れていき、全部隠れた状態で打てたら習熟です。',
...
const en: Record<TranslationKey, string> = {
  ...
  'drill.cloze.desc': 'Work through cloze cards generated from your corrections. Switch to multiple choice with a hint if it\'s too hard.',
  ...
  'drill.levelup.desc':
    'Pick a date and work through that day\'s expressions leveled up one CEFR step. Each correct answer hides more words; type it fully masked to master it.',
