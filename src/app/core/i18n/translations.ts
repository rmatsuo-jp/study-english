...
const ja = {
  ...
  'drill.mistakes.name': '頻出ミス',
  'drill.mistakes.desc': 'あなたが過去によく間違えた表現を、正しい形に直します。',
  'drill.mistakes.empty': '添削ページでミスを蓄積すると出題されます。',
  'drill.cloze.name': '穴埋め復習',
  'drill.cloze.desc': '添削から作った穴埋めカード。難しければヒントで4択に切り替えられます。',
  'drill.cloze.empty': '「復習カードの自動生成」を有効にして添削すると出題されます。',
  'drill.levelup.name': 'レベルアップ・タイピング',
  'drill.levelup.desc':
    '日付を選んで、その日のCEFR一段階上の表現を1文目から。正解するたびに単語が少しずつ隠れていき、全部隠れた状態で打てたら習熟です。',
  ...
  'drill.promptMistake': '次の表現を正しく直してください。',
  ...
  'settings.apiKeyHint': 'Google AI Studio で取得できます。',
...
const en: Record<TranslationKey, string> = {
  ...
  'drill.mistakes.name': 'Frequent Mistakes',
  'drill.mistakes.desc': 'Corrects expressions you have frequently gotten wrong in the past.',
  'drill.mistakes.empty': 'Accumulate mistakes on the Correction page to get questions here.',
  'drill.cloze.name': 'Cloze Review',
  'drill.cloze.desc': 'Cloze cards generated from your corrections. Switch to multiple choice with a hint if it\'s too hard.',
  ...
  'drill.levelup.desc':
    'Pick a date and work through that day\'s expressions leveled up one CEFR step, sentence by sentence. Each correct answer hides more words; type it fully masked to master it.',
  ...
  'drill.promptMistake': 'Correct the following expression.',
  ...
  'settings.apiKeyHint': 'You can obtain one from Google AI Studio.',
